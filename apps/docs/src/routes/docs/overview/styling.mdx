...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="tsx">
    ...
    export const Popover = () => {
      return (
        <PopoverPrimitive>
          <PopoverPrimitive.Trigger class="popover__trigger">
            Open
          </PopoverPrimitive.Trigger>
          <PopoverPrimitive.Content class="popover__content">
            ...
...
export const Popover = () => (
  <PopoverPrimitive>
    <PopoverPrimitive.Trigger class="ui-disabled:bg-slate-100">Open</PopoverPrimitive.Trigger>
    <PopoverPrimitive.Content class="ui-expanded:shadow-md">...</PopoverPrimitive.Content>
  </PopoverPrimitive>
);
```
...
export const Popover = () => {
  return (
    <PopoverPrimitive>
      <PopoverPrimitive.Trigger as={MyButton}>Open</PopoverPrimitive.Trigger>
