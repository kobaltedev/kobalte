...
badges:
  ...
  - label: "@kobalte/core/rating"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/rating"
status: new
---
...
```tsx title="index.tsx" tab file="../../../../examples/rating.tsx#L5-L24"

```

```css title="style.css" tab file="../../../../examples/rating.module.css"
