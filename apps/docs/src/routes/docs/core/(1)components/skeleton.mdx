...
badges:
  - icon: npm
    label: "Since v0.11.1"
  - label: "@kobalte/core/skeleton"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/skeleton"
---
...
```tsx title="index.tsx" tab file="../../../../examples/skeleton.tsx#L1-L17"
```

```css title="style.css" tab file="../../../../examples/skeleton.module.css"
```
