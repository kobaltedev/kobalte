...
badges:
  - icon: npm
    label: "Since v0.11.2"
  - label: "@kobalte/core/slider"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/slider"
  - icon: aria
    label: "Slider"
...
```tsx title="index.tsx" tab file="../../../../examples/slider.tsx#L1-L21"
```

```css title="style.css" tab file="../../../../examples/slider.module.css"
```
