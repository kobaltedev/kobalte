...
badges:
  - icon: npm
    label: "Since v0.1.0"
  - label: "@kobalte/core/hover-card"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/hover-card"
---
...
```tsx title="index.tsx" tab file="../../../../examples/hover-card.tsx#L1-L32"
```

```css title="style.css" tab file="../../../../examples/hover-card.module.css"
```
