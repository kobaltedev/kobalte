...
badges:
  - icon: npm
    label: "Since v0.13.9"
  - label: "@kobalte/core/color-wheel"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/color-wheel"
---
...
```tsx title="index.tsx" tab file="../../../../examples/color-wheel.tsx#L5-L18"
```

```css title="style.css" tab file="../../../../examples/color-wheel.module.css"
```
