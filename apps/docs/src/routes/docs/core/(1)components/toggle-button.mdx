...
badges:
  - icon: npm
    label: "Since v0.1.0"
  - label: "@kobalte/core/toggle-button"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/toggle-button"
  - icon: aria
    label: "Button"
...
```tsx title="index.tsx" tab file="../../../../examples/toggle-button.tsx#L1-L20"
```

```css title="style.css" tab file="../../../../examples/toggle-button.module.css"
```
...
`ToggleButton` consists of [Button](/docs/core/components/button) and additional props.
