...
badges:
  - icon: npm
    label: "Since v0.5.0"
  - label: "@kobalte/core/progress"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/progress"
---
...
```tsx title="index.tsx" tab file="../../../../examples/progress.tsx#L3-L19"
```

```css title="style.css" tab file="../../../../examples/progress.module.css"
```
