...
badges:
  - icon: npm
    label: "Since v0.13.9"
  - label: "@kobalte/core/color-slider"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/color-slider"
---
...
```tsx title="index.tsx" tab file="../../../../examples/color-slider.tsx#L1-L24"
```

```css title="style.css" tab file="../../../../examples/color-slider.module.css"
```
