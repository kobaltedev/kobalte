...
badges:
  - icon: npm
    label: "Since v0.13.9"
  - label: "@kobalte/core/color-channel-field"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/color-channel-field"
  - icon: aria
    label: "Spinbutton"
...
- **ColorChannelField.HiddenInput**: The native HTML input of the color channel field, used for raw number form submission.
...
```tsx title="index.tsx" tab file="../../../../examples/color-channel-field.tsx#L1-L30"
```

```css title="style.css" tab file="../../../../examples/color-channel-field.module.css"
```
...
`ColorChannelField.Label`, `ColorChannelField.Input`, `ColorChannelField.HiddenInput`, `ColorChannelField.Description` and `ColorChannelField.ErrorMessage` share the same data-attributes.
