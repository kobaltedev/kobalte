...
badges:
  - icon: npm
    label: "Since v0.10.0"
  - label: "@kobalte/core/pagination"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/pagination"
---
...
```tsx title="index.tsx" tab file="../../../../examples/pagination.tsx#L1-L29"
```

```css title="style.css" tab file="../../../../examples/pagination.module.css"
```
