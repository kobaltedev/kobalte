...
badges:
  - icon: npm
    label: "Since v0.1.0"
  - label: "@kobalte/core/dropdown-menu"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/dropdown-menu"
  - icon: aria
    label: "Menu button"
...
- Exposed to assistive technology as a button with a menu using the [WAI-ARIA Menu Button](https://www.w3.org/WAI/ARIA/apg/patterns/menu-button/) design pattern.
...
```tsx title="index.tsx" tab file="../../../../examples/dropdown-menu.tsx#L11-L138"
```

```css title="style.css" tab file="../../../../examples/dropdown-menu.module.css"
```
