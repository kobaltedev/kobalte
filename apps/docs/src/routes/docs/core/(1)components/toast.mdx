...
badges:
  - icon: npm
    label: "Since v0.8.0"
  - label: "@kobalte/core/toast"
  - icon: source
    label: "Source"
    url: "https://github.com/kobaltedev/kobalte/tree/main/packages/core/src/toast"
---
...
```tsx title="index.tsx" tab file="../../../../examples/toast.tsx#L4-L65"
```

```css title="style.css" tab file="../../../../examples/toast.module.css"
```
