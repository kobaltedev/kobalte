...
function ControlledExample() {
	...
	return (
		<>
			<NumberField.Root value={value()} onChange={setValue} onRawValueChange={setRawValue}>
				<NumberField.Label>Quantity</NumberField.Label>
				<div>
					<NumberField.Input />
					<NumberField.IncrementTrigger />
...
The `NumberField.Description` component can be used to associate additional help text with a text field.
...
function HTMLFormExample() {
	...
	return (
		<form onSubmit={onSubmit}>
			<NumberField.Root name="favorite-fruit">
				<NumberField.Label>Favorite fruit</NumberField.Label>
				<NumberField.Input />
			</NumberField.Root>
			<div>
...
| onChange        | `(value: string) => void` <br/> Event handler called when the value of the NumberField changes.                                                                           |
...
`NumberField.Label`, `NumberField.Input`, `NumberField.TextArea`, `NumberField.Description` and `NumberField.ErrorMesssage` share the same data-attributes.
