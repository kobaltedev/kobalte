...
import { BasicExample } from "../../../../examples/file-upload";
...
| `maxFileSize`	 | `number` <br /> The maximum size of the file that can be uploaded. |
| `minFileSize`	 | `number` <br /> The minimum size of the file that can be uploaded. |
