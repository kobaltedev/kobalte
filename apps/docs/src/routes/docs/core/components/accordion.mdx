...
By default, accordion items are not collapsible, meaning you can't toggle them from open to close and vice-versa. Use the `isCollapsible` prop to enable this behavior.
