...
import { BasicExample } from "../../../../examples/accordion";
...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="index.tsx">
    ...
    function App() {
      return (
        <Accordion.Root class="accordion" defaultValue={["item-1"]} isCollapsible>
  ...
  <TabsSnippets.Content value="style.css">
    ...
    .accordion__item-trigger[data-focus-visible] {
      z-index: 1;
    ...
    .accordion__item-content:not([data-expanded]) {
