...
<TabsSnippets>
	...
	<TabsSnippets.Content value="index.tsx">
		...
		<ToggleGroup.Root class="toggle-group">
...
| orientation  | `'automatic' \| 'manual'` <br/> The orientation of the toggle group.                                                                    |
...
| disabled | `string \| string[]` <br/> Whether the item is disabled.                                                                                                                               |
