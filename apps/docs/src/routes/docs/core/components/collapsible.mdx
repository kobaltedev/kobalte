...
import { BasicExample, AnimatingContentExample } from "../../../../examples/collapsible";
    ...
    function App() {
      return (
        <Collapsible.Root class="collapsible">
          ...
          <Collapsible.Content class="collapsible__container">
...
<Preview class="h-[324px] !justify-start">
  <AnimatingContentExample />
</Preview>
...
.collapsible__container[data-expanded] {
