...
| children         | `JSX.Element \| (state: ToggleButtonState) => JSX.Element` | The children of the toggle button. Can be a `JSX.Element` or a _render prop_ for having access to the internal state.                                                         |
