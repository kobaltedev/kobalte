...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="style.css">
    ...
    .toggle-button[data-focus-visible] {
...
The following examples are styled like the above example.
...
```tsx
<ToggleButton defaultIsPressed>...</ToggleButton>
```
...
function ControlledExample() {
  ...
  return (
    <>
      <ToggleButton isPressed={pressed()} onPressedChange={setPressed}>
        ...
      </ToggleButton>
