...
<TabsSnippets>
        ...
        <ContextMenu onAction={handleAction}>
          ...
          <ContextMenu.Portal>
            <ContextMenu.Content class="context-menu__content">
              <ContextMenu.Item key="commit" class="context-menu__item">
                Commit <div class="context-menu__item-right-slot">⌘+K</div>
              </ContextMenu.Item>
              <ContextMenu.Item key="push" class="context-menu__item">
                Push <div class="context-menu__item-right-slot">⇧+⌘+K</div>
              </ContextMenu.Item>
              <ContextMenu.Item key="update-project" class="context-menu__item" isDisabled>
                Update Project <div class="context-menu__item-right-slot">⌘+T</div>
              </ContextMenu.Item>
              <ContextMenu.Sub gutter={4} shift={-8}>
                <ContextMenu.SubTrigger key="github" class="context-menu__sub-trigger">
                  GitHub
                ...
                <ContextMenu.Portal>
                  <ContextMenu.SubContent class="context-menu__sub-content">
                    <ContextMenu.Item key="create-pull-request" class="context-menu__item">
                      Create Pull Request…
                    </ContextMenu.Item>
                    <ContextMenu.Item key="view-pull-requests" class="context-menu__item">
                      View Pull Requests
                    </ContextMenu.Item>
                    <ContextMenu.Item key="sync-fork" class="context-menu__item">
                      Sync Fork
                    </ContextMenu.Item>
                    <ContextMenu.Separator class="context-menu__separator" />
                    <ContextMenu.Item key="open-on-github" class="context-menu__item">
                      Open on GitHub
                    </ContextMenu.Item>
                  </ContextMenu.SubContent>
                </ContextMenu.Portal>
  ...
  <TabsSnippets.Content value="style.css">
    ...
    .context-menu__item[data-focus],
    .context-menu__checkbox-item[data-focus],
    .context-menu__radio-item[data-focus],
    .context-menu__sub-trigger[data-focus] {
      outline: none;
    ...
    [data-focus] > .context-menu__item-right-slot {
      color: white;
    }
...
| Prop       | Description                                                          |
| :--------- | :------------------------------------------------------------------- |
| isDisabled | `boolean` <br/> Whether the context menu trigger is disabled or not. |
