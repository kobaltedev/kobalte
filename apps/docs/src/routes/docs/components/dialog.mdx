...
| Key                               | Description                                                              |
| :-------------------------------- | :----------------------------------------------------------------------- |
| <Kbd>Space</Kbd>                  | On the trigger, opens/closes the dialog.                                 |
| <Kbd>Enter</Kbd>                  | On the trigger, opens/closes the dialog.                                 |
| <Kbd>Tab</Kbd>                    | In the dialog content, moves focus to the next focusable element.        |
| <Kbd>Shift</Kbd> + <Kbd>Tab</Kbd> | In the dialog content, moves focus to the previous focusable element.    |
| <Kbd>Esc</Kbd>                    | In the dialog content, closes the dialog and moves focus to the trigger. |
