...
<Preview isCentered>
  <Switch value="on" class="inline-flex items-center">
    <Switch.Input />
    <Switch.Label class="mr-3 text-sm text-zinc-900 dark:text-zinc-300">Airplane mode</Switch.Label>
    <Switch.Control class="inline-flex transition items-center px-[2px] w-11 h-6 bg-zinc-200 outline-none ui-focus-visible:ring ui-focus-visible:ring-blue-100 dark:ui-focus-visible:ring-blue-900/60 rounded-full dark:bg-zinc-700 dark:border-zinc-600 ui-checked:bg-blue-600 dark:ui-checked:bg-blue-600">
      <Switch.Thumb class="ui-checked:translate-x-full ui-checked:border-white bg-white after:border-zinc-300 border rounded-full h-5 w-5 transition-all" />
    </Switch.Control>
  </Switch>
</Preview>
...
- [TODO] Syncs with form reset events.
- [TODO] Labeling support for assistive technology.
