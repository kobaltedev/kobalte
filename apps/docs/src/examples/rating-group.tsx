...
export function BasicExample() {
	return (
		<RatingGroup count={5} class={style["rating-group"]}>
			...
			<RatingGroup.Control class={style["rating-group__control"]}>
				{({ items }) => (
					<For each={items}>
						{(item) => (
							<RatingGroup.Item index={item} class={style["rating-group-item"]}>
...
export function DefaultValueExample() {
	return (
		<RatingGroup defaultValue={2.5} count={5} class={style["rating-group"]}>
			<RatingGroup.Label class={style["rating-group__label"]}>
				Rating:
			</RatingGroup.Label>
			<RatingGroup.Control class={style["rating-group__control"]}>
...
export function HalfRatingsExample() {
	return (
		<RatingGroup count={5} class={style["rating-group"]} allowHalf>
			<RatingGroup.Control class={style["rating-group__control"]}>
				{({ items }) => (
					<For each={items}>
						{(item) => (
...
export function HTMLFormExample() {
	...
	return (
		...
		>
			<RatingGroup count={5} class={style["rating-group"]} name="rate">
				<RatingGroup.Control class={style["rating-group__control"]}>
					{({ items }) => (
						<For each={items}>
							{(item) => (
