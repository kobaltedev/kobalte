			...
			<DropdownMenu.Portal>
				<DropdownMenu.Content class={style["dropdown-menu__content"]}>
					<DropdownMenu.Item class={style["dropdown-menu__item"]}>
						Commit{" "}
						<div class={style["dropdown-menu__item-right-slot"]}>⌘+K</div>
					</DropdownMenu.Item>
					<DropdownMenu.Item class={style["dropdown-menu__item"]}>
						Push{" "}
						<div class={style["dropdown-menu__item-right-slot"]}>⇧+⌘+K</div>
					...
					<DropdownMenu.Item class={style["dropdown-menu__item"]} disabled>
						Update Project{" "}
						<div class={style["dropdown-menu__item-right-slot"]}>⌘+T</div>
					</DropdownMenu.Item>
					<DropdownMenu.Sub overlap gutter={4} shift={-8}>
						<DropdownMenu.SubTrigger
							class={style["dropdown-menu__sub-trigger"]}
						>
							GitHub
						...
						<DropdownMenu.Portal>
							<DropdownMenu.SubContent
								class={style["dropdown-menu__sub-content"]}
							>
								<DropdownMenu.Item class={style["dropdown-menu__item"]}>
									Create Pull Request…
								</DropdownMenu.Item>
								...
								<DropdownMenu.Separator
									class={style["dropdown-menu__separator"]}
								/>
								<DropdownMenu.Item class={style["dropdown-menu__item"]}>
									Open on GitHub
								</DropdownMenu.Item>
					...
					>
						<DropdownMenu.ItemIndicator
							class={style["dropdown-menu__item-indicator"]}
						>
							<CheckIcon />
						</DropdownMenu.ItemIndicator>
						Show Git Log
					...
					<DropdownMenu.Group>
						<DropdownMenu.GroupLabel
							class={style["dropdown-menu__group-label"]}
						>
							Branches
						</DropdownMenu.GroupLabel>
						<DropdownMenu.RadioGroup value={branch()} onChange={setBranch}>
							<DropdownMenu.RadioItem
								class={style["dropdown-menu__radio-item"]}
								value="main"
							>
								<DropdownMenu.ItemIndicator
									class={style["dropdown-menu__item-indicator"]}
