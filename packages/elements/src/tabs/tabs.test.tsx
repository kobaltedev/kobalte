  ...
  it("renders properly", async () => {
    render(() => (
      <Tabs>
        ...
        <Tabs.TabPanel value="one">Body 1</Tabs.TabPanel>
        <Tabs.TabPanel value="two">Body 2</Tabs.TabPanel>
        <Tabs.TabPanel value="three">Body 3</Tabs.TabPanel>
      </Tabs>
    ));
  ...
  it("selects first tab if all tabs are disabled", async () => {
    render(() => (
      <Tabs onValueChange={onValueChangeSpy}>
        <Tabs.TabList>
          <Tabs.Tab value="one" isDisabled>
            One
          </Tabs.Tab>
          <Tabs.Tab value="two" isDisabled>
            Two
          </Tabs.Tab>
          <Tabs.Tab value="three" isDisabled>
            Three
          </Tabs.Tab>
        </Tabs.TabList>
        <Tabs.TabPanel value="one">Body 1</Tabs.TabPanel>
  ...
  it("tabpanel should have tabIndex=0 only when there are no focusable elements", async () => {
    render(() => (
      <Tabs>
        ...
        <Tabs.TabPanel value="one">
          <input />
        </Tabs.TabPanel>
        <Tabs.TabPanel value="two">
          <input disabled />
        </Tabs.TabPanel>
      </Tabs>
    ));
