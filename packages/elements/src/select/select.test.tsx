...
describe("Select", () => {
          ...
          <Select.Portal>
            <Select.Positioner>
              <Select.Panel>
                <Select.Listbox>
                  <Select.Option value="1">One</Select.Option>
                  <Select.Option value="2" isDisabled>
                    Two
                  </Select.Option>
                  <Select.Option value="3">Three</Select.Option>
                </Select.Listbox>
  ...
  describe("multi selection", () => {
    it("supports selecting multiple options", async () => {
      render(() => (
        <Select selectionMode="multiple" onValueChange={onValueChange}>
          <Select.Label>Label</Select.Label>
          <Select.Trigger>
            <Select.Value placeholder="Placeholder" />
          </Select.Trigger>
    ...
    it("supports multiple defaultValue (uncontrolled)", async () => {
      ...
      render(() => (
        <Select selectionMode="multiple" defaultValue={defaultValue} onValueChange={onValueChange}>
          <Select.Label>Label</Select.Label>
          <Select.Trigger>
            <Select.Value placeholder="Placeholder" />
          </Select.Trigger>
    ...
    it("supports multiple value (controlled)", async () => {
      ...
      render(() => (
        <Select selectionMode="multiple" value={value} onValueChange={onValueChange}>
          <Select.Label>Label</Select.Label>
          <Select.Trigger>
            <Select.Value placeholder="Placeholder" />
          </Select.Trigger>
              ...
              <Select.Panel>
                <Select.Listbox>
                  <For each={ADDRESS_DATA}>
                    {data => <Select.Option value={data.value}>{data.label}</Select.Option>}
                  </For>
                </Select.Listbox>
              </Select.Panel>
            </Select.Positioner>
