...
export function findDOMIndex(items: CollectionItem[], item: CollectionItem) {
...
function sortBasedOnDOMPosition<T extends CollectionItem>(items: T[]) {
...
function setItemsBasedOnDOMPosition<T extends CollectionItem>(
  items: T[],
...
function getCommonParent(items: CollectionItem[]) {
...
function createTimeoutObserver<T extends CollectionItem = CollectionItem>(
  items: Accessor<T[]>,
  setItems: (items: T[]) => any
) {
  createEffect(() => {
...
export function createSortBasedOnDOMPosition<T extends CollectionItem = CollectionItem>(
  items: Accessor<T[]>,
  setItems: (items: T[]) => any
) {
