...
export interface AlertDialogOverlayOptions extends AsChildProp {
  /** The HTML styles attribute (object form only). */
  style?: JSX.CSSProperties;
}

export interface AlertDialogOverlayProps
  extends OverrideComponentProps<"div", AlertDialogOverlayOptions> {}
  ...
  return (
    <Show when={context.overlayPresence.isPresent()}>
      <Polymorphic
        ...
        // We re-enable pointer-events prevented by `AlertDialog.Content` to allow scrolling.
