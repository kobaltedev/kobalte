...
export interface AlertDialogContentOptions extends AsChildProp {
  /**
...
export interface AlertDialogContentProps
  extends OverrideComponentProps<"div", AlertDialogContentOptions> {}

/**
 * Contains the content to be rendered when the alert dialog is open.
 */
