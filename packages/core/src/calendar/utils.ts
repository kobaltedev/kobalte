...
type CalendarValue = DateValue | DateValue[] | RangeValue<DateValue>;

export function asCalendarValue<T extends CalendarValue>(
	value: CalendarValue | null | undefined,
): T | null | undefined {
	return value as T | null | undefined;
}

export const asSingleValue = (v: CalendarValue | null | undefined) =>
	asCalendarValue<DateValue>(v);

export const asArrayValue = (v: CalendarValue | null | undefined) =>
	asCalendarValue<DateValue[]>(v);

export const asRangeValue = (v: CalendarValue | null | undefined) =>
	asCalendarValue<RangeValue<DateValue>>(v);
