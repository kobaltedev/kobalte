 ...
 */
export const CalendarCell = /*#__PURE__*/ createPolymorphicComponent<"td", CalendarCellOptions>(
  props => {
...
const CalendarCellBase = /*#__PURE__*/ createPolymorphicComponent<"td", CalendarCellBaseOptions>(
  props => {
    const calendarContext = useCalendarContext();
