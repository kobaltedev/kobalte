...
describe("Menubar", () => {
  it("renders correctly", async () => {
    ...
    expect(screen.getByText("Test 1")).toHaveAttribute("data-highlighted", "true");
    ...
    expect(screen.getByText("Test 1")).not.toHaveAttribute("data-highlighted", "true");
    expect(screen.getByText("Test 2")).toHaveAttribute("data-highlighted", "true");
    ...
    expect(screen.getByText("Test 2")).not.toHaveAttribute("data-highlighted", "true");
  ...
  it("handles keyboard navigation correctly", async () => {
    ...
    fireEvent.keyPress(screen.getByText("Test 1"), { key: "ArrowRight", code: "ArrowRight" });
    ...
    fireEvent.keyPress(screen.getByText("Test 2"), { key: "ArrowRight", code: "ArrowRight" });

    expect(screen.queryByText("Item Z")).not.toBeInTheDocument();

    expect(screen.getByText("Test 2")).not.toHaveAttribute("data-highlighted", "true");
    expect(screen.getByText("Test 3")).toHaveAttribute("data-highlighted", "true");
    ...
    fireEvent.keyPress(screen.getByText("Test 3"), { key: "ArrowRight", code: "ArrowRight" });

    expect(screen.getByText("Test 1")).toHaveFocus();

    fireEvent.keyPress(screen.getByText("Test 1"), { key: "ArrowDown", code: "ArrowDown" });
    ...
    fireEvent.keyPress(document.activeElement as Element, { key: "ArrowDown", code: "ArrowDown" });
    ...
    fireEvent.keyPress(document.activeElement as Element, { key: "ArrowLeft", code: "ArrowLeft" });
