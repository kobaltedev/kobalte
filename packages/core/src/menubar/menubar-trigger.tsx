...
export interface MenubarTriggerOptions extends AsChildProp {
...
export interface MenubarTriggerOptions
  extends OverrideComponentProps<"div", MenubarTriggerOptions> {}

export function MenubarTrigger(props: MenubarTriggerOptions) {
